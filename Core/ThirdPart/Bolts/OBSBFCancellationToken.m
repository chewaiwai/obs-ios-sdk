...
@interface OBSBFCancellationToken ()
...
@interface OBSBFCancellationTokenRegistration (OBSBFCancellationToken)
...
@implementation OBSBFCancellationToken
...
- (void)notifyCancellation:(NSArray *)registrations {
    for (OBSBFCancellationTokenRegistration *registration in registrations) {
...
- (OBSBFCancellationTokenRegistration *)registerCancellationObserverWithBlock:(OBSBFCancellationBlock)block {
    @synchronized(self.lock) {
        OBSBFCancellationTokenRegistration *registration = [OBSBFCancellationTokenRegistration registrationWithToken:self delegate:[block copy]];
