...
@interface OBSBFExecutor ()

@property (nonatomic, copy) void(^block)(void(^block)(void));

@end

@implementation OBSBFExecutor

#pragma mark - Executor methods

+ (instancetype)defaultExecutor {
    static OBSBFExecutor *defaultExecutor = NULL;
...
+ (instancetype)immediateExecutor {
    static OBSBFExecutor *immediateExecutor = NULL;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
...
+ (instancetype)mainThreadExecutor {
    static OBSBFExecutor *mainThreadExecutor = NULL;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
