...
SEL OBSMTLSelectorWithKeyPattern(NSString *key, const char *suffix) {
...
SEL OBSMTLSelectorWithCapitalizedKeyPattern(const char *prefix, NSString *key, const char *suffix) {
